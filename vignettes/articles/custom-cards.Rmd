...
galleries %>% 
  cards(
    ...
    image = image_url,
    layout = "inset-top", 
    label_colour = "#ffffffcc"
  )
```

(Notice I set a partially transparent `label_colour` for the labels in this example. I'll talk about colours later, but inset layouts in particular tend to benefit from choosing a judicious label colour)
