...
If you know a little bootstrap you can exercise finer-grained control over the card widths by passng a string rather than a number. This string is interpreted as a set of CSS classes and is passed directly into the output. Internally, this snippet of code shows how the numeric widths are translated to bootstrap classes:
