...
card_classes <- function(gutter) {
  paste0("card bg-transparent m-0 p-", gutter, " border-0")
}

image_classes <- function(layout) {
  card_type <- "card-img"
...
body_vertical_classes <- function(padding) {
...
label_horizontal_classes <- function(breakpoint) {
...
image_horizontal_classes <- function(breakpoint) {
